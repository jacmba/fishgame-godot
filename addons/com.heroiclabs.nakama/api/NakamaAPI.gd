...
class GroupUserListGroupUser extends NakamaAsyncResult:
	...
	var state : int: get = _get_state
	var _state = null
	func _get_state() -> int:
		return 0 if not _state is int else int(_state)

	# User.
	var user : ApiUser: get = _get_user
	var _user = null
...
class UserGroupListUserGroup extends NakamaAsyncResult:
	...
	# Group.
	var group : ApiGroup: get = _get_group
	var _group = null
...
class WriteLeaderboardRecordRequestLeaderboardRecordWrite extends NakamaAsyncResult:
	...
	var metadata : String: get = _get_metadata
	var _metadata = null
	...
	var subscore : String: get = _get_subscore
	var _subscore = null
...
class ApiAccountCustom extends NakamaAsyncResult:
	...
	var vars : Dictionary: get = _get_vars
	var _vars = null
...
class ApiAccountEmail extends NakamaAsyncResult:
	...
	var password : String: get = _get_password
	var _password = null
...
class ApiAccountFacebook extends NakamaAsyncResult:
	...
	var token : String: get = _get_token
	var _token = null
...
class ApiAccountFacebookInstantGame extends NakamaAsyncResult:
	...
	# 
	var signed_player_info : String: get = _get_signed_player_info
...
class ApiChannelMessage extends NakamaAsyncResult:
	...
	var user_id_one : String: get = _get_user_id_one
	...
	var user_id_two : String: get = _get_user_id_two
...
class ApiChannelMessageList extends NakamaAsyncResult:
	...
	var prev_cursor : String: get = _get_prev_cursor
...
class ApiCreateGroupRequest extends NakamaAsyncResult:
	...
	var avatar_url : String: get = _get_avatar_url
...
class ApiDeleteStorageObjectsRequest extends NakamaAsyncResult:
	...
	var object_ids : Array: get = _get_object_ids
...
class ApiEvent extends NakamaAsyncResult:
	...
	var external : bool: get = _get_external
	var _external = null
...
class ApiGroup extends NakamaAsyncResult:
	...
	var creator_id : String: get = _get_creator_id
	...
	var edge_count : int: get = _get_edge_count
...
class ApiGroupList extends NakamaAsyncResult:
	...
	# One or more groups.
	var groups : Array: get = _get_groups
	var _groups = null
...
class ApiGroupUserList extends NakamaAsyncResult:
	...
	var group_users : Array: get = _get_group_users
...
class ApiLeaderboardRecord extends NakamaAsyncResult:
	...
	var max_num_score : int: get = _get_max_num_score
...
class ApiLeaderboardRecordList extends NakamaAsyncResult:
	...
	var owner_records : Array: get = _get_owner_records
	...
	var records : Array: get = _get_records
	var _records = null
...
class ApiMatchList extends NakamaAsyncResult:
	...
	var matches : Array: get = _get_matches
	var _matches = null
...
class ApiNotification extends NakamaAsyncResult:
	...
	var subject : String: get = _get_subject
	var _subject = null
...
class ApiNotificationList extends NakamaAsyncResult:
	...
	var cacheable_cursor : String: get = _get_cacheable_cursor
	...
	var notifications : Array: get = _get_notifications
...
class ApiReadStorageObjectId extends NakamaAsyncResult:
	...
	var user_id : String: get = _get_user_id
	var _user_id = null
...
class ApiRpc extends NakamaAsyncResult:
	...
	var http_key : String: get = _get_http_key
	var _http_key = null
	...
	var payload : String: get = _get_payload
	var _payload = null
...
class ApiSession extends NakamaAsyncResult:
	...
	var created : bool: get = _get_created
	var _created = null
...
class ApiStorageObject extends NakamaAsyncResult:
	...
	var permission_read : int: get = _get_permission_read
	...
	var permission_write : int: get = _get_permission_write
	...
	var value : String: get = _get_value
	var _value = null
...
class ApiStorageObjectList extends NakamaAsyncResult:
	...
	var objects : Array: get = _get_objects
	var _objects = null
...
class ApiTournament extends NakamaAsyncResult:
	...
	var next_reset : int: get = _get_next_reset
...
class ApiTournamentList extends NakamaAsyncResult:
	...
	var tournaments : Array: get = _get_tournaments
...
class ApiUser extends NakamaAsyncResult:
	...
	var gamecenter_id : String: get = _get_gamecenter_id
	...
	var google_id : String: get = _get_google_id
	var _google_id = null
...
class ApiUserGroupList extends NakamaAsyncResult:
	...
	var user_groups : Array: get = _get_user_groups
...
class ApiUsers extends NakamaAsyncResult:
	...
	# The User objects.
	var users : Array: get = _get_users
	var _users = null
...
class ApiClient extends RefCounted:
	...
	func healthcheck_async(
		...
		var result = await _http_adapter.send_async(method, uri, headers, content, _timeout).completed
