...
func _init():
	_ws.connect("data_received", Callable(self, "_received"))
	_ws.connect("connection_established", Callable(self, "_connected"))
	_ws.connect("connection_error", Callable(self, "_error"))
	_ws.connect("connection_closed", Callable(self, "_closed"))
